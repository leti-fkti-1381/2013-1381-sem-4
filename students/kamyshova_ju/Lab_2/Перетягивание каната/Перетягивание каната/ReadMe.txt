========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Перетягивание каната
========================================================================

Это приложение Перетягивание каната создано автоматически с помощью мастера 
приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения Перетягивание каната.


Перетягивание каната.vcxproj
...
Перетягивание каната.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем Перетягивание каната.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
